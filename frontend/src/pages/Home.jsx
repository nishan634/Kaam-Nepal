...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {/* Hero */}
      <section className="relative w-full bg-surface-container-low overflow-hidden py-space-xl lg:py-20 px-margin md:px-margin-md lg:px-margin-lg">
        <div className="absolute -top-24 -left-20 w-96 h-96 rounded-full bg-primary-fixed opacity-40 blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -right-20 w-96 h-96 rounded-full bg-secondary-fixed opacity-30 blur-3xl pointer-events-none" />
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="font-display text-display-hero-mobile lg:text-display-hero text-primary max-w-4xl mx-auto">
            Every skill deserves a fair shot. <span className="text-secondary">काम पाउनुहोस्।</span>
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mt-space-md">
            From master electricians to remote software engineers — KAAM Nepal connects the
            country's talent with verified employers, daily-wage work, and global freelance gigs.
          </p>

          <form
            onSubmit={(e) => e.preventDefault()}
            className="mt-space-lg max-w-2xl mx-auto flex flex-col sm:flex-row items-center gap-space-sm bg-surface-container-lowest p-space-sm rounded-xl shadow-lg"
          >
            ...
            <Link
              to={`/find-jobs?search=${encodeURIComponent(query)}`}
      ...
      <section className="max-w-7xl mx-auto w-full px-margin md:px-margin-md lg:px-margin-lg py-space-xl">
        <div className="flex items-center justify-between mb-space-md">
          <div>
            <h2 className="font-display text-headline-md text-primary">Jobs Near You</h2>
      ...
      <section className="w-full bg-surface-container-low py-space-xl px-margin md:px-margin-md lg:px-margin-lg">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-space-md">
            <div>
              <h2 className="font-display text-headline-md text-primary">Popular Freelance Gigs</h2>
              <p className="font-body-sm text-body-sm text-on-surface-variant">
      ...
      <section className="max-w-7xl mx-auto w-full px-margin md:px-margin-md lg:px-margin-lg py-space-xl">
        <div className="bg-primary-container rounded-xl px-space-lg py-space-xl text-center">
          <h2 className="font-display text-headline-md text-on-primary mb-space-sm">Hiring in Nepal?</h2>
